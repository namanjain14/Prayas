...
#include <string.h>
//#include "fatfs\ff.h"			/* FatFs declarations */
#include "ff.h"					/* FatFs declarations */
#include "diskio.h"
//#include "fatfs\diskio.h"		/* Include file for user provided disk functions */
#include "Compiler.h"
...
//PARIJAT			tim = get_fattime();					/* Updated time */
...
//PARIJAT	n = get_fattime();							/* Use current time as a VSN */
	if (fmt != FS_FAT32) {
