 ...
 *****************************************************************************
 *
 * 11/17/08	V1.00 D.Wenn		Placeholder for ATA drive translation
 *
 *****************************************************************************/
...
/******************************************************************************
 * Function:        DSTATUS ATA_disk_initialize(void)
 *
 * PreCondition:    None
 *
 * Input:           None
...
/******************************************************************************
 * Function:        DSTATUS ATA_disk_status(void)
 *
 * PreCondition:    None
 *
...
/******************************************************************************
 * Function:        DRESULT ATA_disk_read(BYTE *buff,
 *									  DWORD sector,
 *									  BYTE count)
 *
 * PreCondition:    None
 ...
 * Note:            None
 *****************************************************************************/
DRESULT ATA_disk_read(BYTE *buff, DWORD sector, BYTE count)
{
	return RES_NOTRDY;
}  

/******************************************************************************
 * Function:        DRESULT ATA_disk_write(const BYTE *buff,
 *									   DWORD sector,
 *									   BYTE count)
 *
 * PreCondition:    None
 ...
 *****************************************************************************/
#if _READONLY == 0
DRESULT ATA_disk_write(const BYTE *buff, DWORD sector, BYTE count)
{
	return RES_NOTRDY;   
}
#endif
...
/******************************************************************************
 * Function:        DRESULT ATA_disk_ioctl(BYTE ctrl, void* buff)
 *
 * PreCondition:    None
 *
